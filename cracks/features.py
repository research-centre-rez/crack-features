...
def phase_analysis(crack_mask_smooth, phase_map):
    ...
    @return: 3D array with two dimensions corresponding to pixels and 3rd dimension containing
        [left phase, right phase, left neighbor [x,y], right neighbor [x, y]]
    """
    ...
    phase_map[crack_mask_smooth] = -2  # erase phase information where cracks were detected
